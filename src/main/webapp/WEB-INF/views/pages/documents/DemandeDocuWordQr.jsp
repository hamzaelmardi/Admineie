    ...
    <div class="container p-0 mt-5 border border-dark" style="width: 1000px; border-style: dashed !important;">
        ...
        <div class="d-flex justify-content-center">
            <p class="col-10">
                ...
                ${reunion.date_reunion }    البيئة خلال الاجتماع المنعقد بتاريخ ؛
            </p>
        </div>
        ...
        <div class="d-flex justify-content-center">
            <p class="col-10">
                <b><u>المادة 1 :</u></b>
                 تمنح الموافقة البيئية لمشروع${demande.num_demande}
            </p>
        </div>
        ...
        <img style="float: left;" src="${pageContext.request.contextPath}/assets_admin/images/qr.png" >
