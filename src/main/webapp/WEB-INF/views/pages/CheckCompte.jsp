                                                ...
                                                <div class="border rounded p-2">
                                                    ...
                                                    <div>
                                                        <div class="row justify-content-center" style="margin-top: 5%;">
                                                            <input type="hidden" value="${id}" name="id" id="idUser">
                                                                    <div class="form-group col-md-12">
                                                                        <input autocomplete="new-password" type="password" class="form-control" placeholder="<spring:message code="label.Creerlenouveaumotdepasse"/>" id="password_user" name="password_user">
            ...
            $.ajax({
                ...
                success : function(response) {
                    if(response=="OK")
                    {
                        ...
                        window.location.href="/api/getMenu?lang=ar";
                        </c:if>
                        <c:if test="${pageContext.response.locale!='ar'}">
                        window.location.href="/api/getMenu?lang=fr";
                        </c:if>
                    }
                    else
                    {
