...
<div class="container-fluid" style="margin-top: 150px">
    <div class="content-wrapper p-0">
        <form action="/api/setAutorisationLettreConforme/${id}/XD" method="post" enctype="multipart/form-data">
            <div class="row" >
                        ...
                        <div class="card-body">
                            <div class="row justify-content-center">
                                <div class="col-xl-6 col-lg-8 col-md-8 col-sm-12 mb-2 btn-gris h4 text-white text-center rounded p-2">
                                    <div class="btn-gris"><spring:message code="label.Telechargerlalettredeconsentement"/></div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row justify-content-center">
                                            <div class="col-md-10 col-sm-12">
                                                <a href="/api/generate_word_export_lettre_consentement/${notification.id_notification }" class="btn btn-success btn-block"><spring:message code="label.Telechargerlalettredeconsentement"/> </a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group mt-4">
                                        <div class="row justify-content-center">
                                            <div class="col-10 text-left">
                                                <label class=""> <spring:message code="label.Importerlalettredeconsentement"/> </label>
