              ...
              <div class="card-body bg-white">
                    ...
                    <div class="col-md-12 div1 pl-0">
                      ...
                      <ul class="nav nav-tabs nav-tabs-vertical my_tab rounded" role="tablist" style="display: -webkit-inline-box;width: 100%;">
                          ...
                          <spring:message code="label.Etudedimpactenvironnemental"/> <span class="badge bd badge-info" >4</span>
                          ...
                          <li class="nav-item col-4 p-0" onclick="init_left_menu('profile-2')">
                           ...
                           <spring:message code="label.Noticedimpact"/>   <span class="badge bd badge-danger">2</span>
                        ...
                        <spring:message code="label.Auditenvironnemental"/>    <span class="badge  bd badge-success">8</span>
