...
<script>
    ...
    $(document).ready(function () {
        $.ajax({
            url:"/api/statistique/getSocieteDemandeAjout",
            type:"GET",
            ...
            $(data).each(function(idx,el){
                ...
                var tab1 = '<ul id="chart-selector"> <button class="btn btn-outline-success" onclick="tableToExcel(\'tab_stat\', \'Statistique des autorisations\')"><span style="color:#1b5e20"><i class="fa fa-file-excel"></i> Exporter EXCEL</span></button> </ul>' +
                    '<div id="tab_stat"><p class="text-center" style="color: #003399; font-size: 20px; font-family: sans-serif !important; font-weight: bold">Les sociétés autorisées ayant demande des ajouts des véhicules et déchets</p>' +
                    ...
                    '<thead><tr class="bg-vert text-white"><th style="width: 20%">Nom de société</th></tr>' +
