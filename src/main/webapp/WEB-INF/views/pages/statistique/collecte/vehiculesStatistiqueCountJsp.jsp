...
<script>
    $(document).ready(function () {
        ...
        $.ajax({
            url:"/api/statistique/getCountVehicules",
            type:"GET",
            ...
            if(chart=="1"){
                ...
                var chart = AmCharts.makeChart("resultat", {
                    ...
                    "titles": [
                        {
                            "text": "Nombre des véhicules autorisés",
                            "color":"#003399",
                            "size": 20
                        }
                    ]
                ...
                var tab1 = '<ul id="chart-selector"> <button class="btn btn-outline-success" onclick="tableToExcel(\'tab_stat\', \'Statistique des autorisations\')"><span style="color:#1b5e20"><i class="fa fa-file-excel"></i> Exporter EXCEL</span></button> </ul>' +
                    '<div id="tab_stat"><p class="text-center" style="color: #003399; font-size: 20px; font-family: sans-serif !important; font-weight: bold">Nombre des véhicules autorisés</p>' +
                    ...
                    '<thead><tr class="bg-vert text-white"><th style="width: 20%">Nom de société</th><th>Total</th> </tr>' +
            ...
            $.ajax({
                ...
                if(chart=="1"){
                    ...
                    var chart = AmCharts.makeChart("resultat", {
                        ...
                        "titles": [
                            {
                                "text": "Nombre des demandes d’ajout des véhicules et déchets par les sociétés autorisés",
                                "color":"#003399",
                                "size": 20
                            }
                        ]
                    ...
                    var tab1 = '<ul id="chart-selector"> <button class="btn btn-outline-success" onclick="tableToExcel(\'tab_stat\', \'Statistique des autorisations\')"><span style="color:#1b5e20"><i class="fa fa-file-excel"></i> Exporter EXCEL</span></button> </ul>' +
                        '<div id="tab_stat"><p class="text-center" style="color: #003399; font-size: 20px; font-family: sans-serif !important; font-weight: bold">Nombre des demandes d’ajout des véhicules et déchets par les sociétés autorisés</p>' +
                        '<div class="row justify-content-center mt-4"> <div class="col-md-10 col-sm-12"> ' +
                        '<table class="table table-bordered table-striped table-hover" id="tab_stat"> ' +
                        '<thead><tr class="bg-vert text-white"><th style="width: 20%">Nom de société</th><th>Total</th> </tr>' +
                        ' </thead> <tbody>'+tr+' </tbody> </table> </div> </div>';
