...
<div class="col-12">
    <div class="row justify-content-center" style="height: auto!important; min-height:50vh">
        ...
        <div class="card">
            <div class="card-body">
                <h5 style="text-align:center">Nombre de réunions</h5>
                <hr>
                <form>
                    ...
                    <div class="form-group">
                        <button  onclick="getStat3()" type="button" class="btn btn-primary float-right"><spring:message code='label.Rechercher'/></button>
                    </div>
                </form>
            </div>
        </div>
