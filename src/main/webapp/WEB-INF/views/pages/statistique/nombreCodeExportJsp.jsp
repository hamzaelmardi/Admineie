                ...
                <div class="card-body">
                    ...
                    <div class="row " style="width: 40%;float: right;">
                        <div class="col-md-4 pie1">
                            <div class="form-group">
                                <div class="custom-control">
                                    <label><img src="/assets/images/chart1.png" class="w-100 img_chart" width="70%" onclick="fun_changesXD(1,this)"></label>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 chart1">
                            <div class="form-group">
                                <div class="custom-control">
                                    ...
                                    <label><img src="/assets/images/chart2_gris.png"  class="w-100 img_chart" width="70%" onclick="fun_changesXD(2,this)"></label>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 tab1">
                            <div class="form-group">
                                <div class="custom-control">
                                    <label><img src="/assets/images/chart3_gris.png"  class="w-100 img_chart" width="70%" onclick="fun_changesXD(3,this)"></label>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    function fun_changesXD(id,val){
        ...
        $(document).ready(function (){
            $.ajax({
                url:"/api/statistique/getNombreCodeXD",
                type:"GET",
                ...
                if(chart=="1"){
                    var chart = AmCharts.makeChart("resultat", {
                        ...
                        "titles": [
                            {
                                "text": "Nombre des autorisations délivrées pour exportation des déchets aux pays Etrangers ",
                                "color":"#003399",
                                "size": 20
                            }
                        ]
                    ...
                    $(dataProvider).each(function(ind,el){
                        tr+="<tr><td>"+el.code+"</td><td>"+el.type+"<td>"+el.total+"</td></tr>";
                    })
                    var tab1 = '<ul id="chart-selector"> <button class="btn btn-outline-success" onclick="tableToExcel(\'tab_stat\', \'Statistique des autorisations\')"><span style="color:#1b5e20"><i class="fa fa-file-excel"></i> Exporter EXCEL</span></button> </ul>' +
                        '<div id="tab_stat"><p class="text-center" style="color: #003399; font-size: 20px; font-family: sans-serif !important; font-weight: bold">Nombre des autorisations délivrées pour exportation des déchets aux pays Etrangers </p>' +
                        ...
                        '<thead class="bg-vert text-white"> <tr> <th style="width: 20%">Code</th><th>Type</th> <th>Total</th> </tr>' +
     ...
     $(document).ready(function (){
        $.ajax({
            ...
            if(chart=="1"){
                ...
                var tab1 = '<ul id="chart-selector"> <button class="btn btn-outline-success" onclick="tableToExcel(\'tab_stat\', \'Statistique des autorisations\')"><span style="color:#1b5e20"><i class="fa fa-file-excel"></i> Exporter EXCEL</span></button> </ul>' +
                    '<div id="tab_stat"><p class="text-center" style="color: #003399; font-size: 20px; font-family: sans-serif !important; font-weight: bold">Nombre des autorisations délivrées pour exportation des déchets aux pays Etrangers </p>' +
                    '<div class="row justify-content-center mt-4"> <div class="col-md-8 col-sm-12"> ' +
                    '<table class="table table-bordered table-striped table-hover" id="tab_stat"> ' +
                    '<thead class="bg-vert text-white"> <tr> <th style="width: 20%">Code</th><th>Type</th> <th>Total</th> </tr>' +
                    ' </thead> <tbody>'+tr+' </tbody> </table> </div> </div>';
