                        ...
                        <form>
                            <div class="form-group">
                                <div class="col-auto">
                                    ...
                                    <select id="typeDechet" class="form-control" style="width: 100%">
                            ...
                            <div class="form-group">
                                <button onclick="affichePaysXD()" type="button" class="btn btn-primary"><spring:message code='label.Rechercher'/></button>
                            </div>
                        </form>
                    </div>
                </div>
                            ...
                            <div class="col-md-4 pie1">
                                <div class="form-group">
                                    <div class="custom-control">
                                        <label><img src="/assets/images/chart1.png" class="w-100 img_chart" width="70%" onclick="fun_changesXD1(3,this)"></label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="custom-control">
                                        <label><img src="/assets/images/chart2.png"  class="w-100 img_chart" width="70%" onclick="fun_changesXD1(1,this)"></label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="custom-control">
                                        <label><img src="/assets/images/chart3_gris.png"  class="w-100 img_chart" width="70%" onclick="fun_changesXD1(2,this)"></label>
                                    </div>
                                </div>
                            </div>
