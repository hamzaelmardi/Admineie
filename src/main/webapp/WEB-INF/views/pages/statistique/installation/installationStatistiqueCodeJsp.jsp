                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="custom-control">
                                    <label><img src="/assets/images/chart1.png" class="w-100 img_chart" width="70%" onclick="fun_changes1CT(1,this)"></label>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="custom-control">
                                    ...
                                    <label><img src="/assets/images/chart2_gris.png"  class="w-100 img_chart" width="70%" onclick="fun_changes1CT(2,this)"></label>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="custom-control">
                                    <label><img src="/assets/images/chart3_gris.png"  class="w-100 img_chart" width="70%" onclick="fun_changes1CT(3,this)"></label>
                                </div>
                            </div>
                        </div>
...
<script>
    $(document).ready(function () {
        ...
        $.ajax({
            url:"/api/statistique/getCountInstallationByCode",
            type:"GET",
            ...
            if(chart=="1"){
                var chart = AmCharts.makeChart("resultat", {
                    ...
                    "titles": [
                        {
                            "text": "Nombre des sociétés autorisées à collecter et transporter les Déchets Dangereux ",
                            "color":"#003399",
                            "size": 20
                        }
                    ]
                ...
                var tab1 = '<ul id="chart-selector"> <button class="btn btn-outline-success" onclick="tableToExcel(\'tab_stat\', \'Statistique des autorisations\')"><span style="color:#1b5e20"><i class="fa fa-file-excel"></i> Exporter EXCEL</span></button> </ul>' +
                    '<div id="tab_stat"><p class="text-center" style="color: #003399; font-size: 20px; font-family: sans-serif !important; font-weight: bold">Nombre des sociétés autorisées à collecter et transporter les Déchets Dangereux </p>' +
                    ...
                    '<thead><tr class="bg-vert text-white"><th style="width: 20%">Code</th> <th>Type de déchet</th><th>Total</th> </tr>' +
    ...
    function fun_changes1CT(id,val){
