...
<script>
    $(document).ready(function (){
        $.ajax({
            url:"/api/statistique/getPaysMarocExport",
            type:"GET",
            ...
            var tab1 = '<ul id="chart-selector"> <button class="btn btn-outline-success" onclick="tableToExcel(\'tab_stat\', \'Statistique des autorisations\')"><span style="color:#1b5e20"><i class="fa fa-file-excel"></i> Exporter EXCEL</span></button> </ul>' +
                '<div id="tab_stat"><p class="text-center" style="color: #003399; font-size: 20px; font-family: sans-serif !important; font-weight: bold">Les pays d’exportation des déchets non dangereux du Maroc </p> ' +
                '<div class="row justify-content-center mt-4"> <div class="col-md-10 col-sm-12"> ' +
                '<table class="table table-bordered table-striped table-hover"> ' +
                '<thead class="bg-vert text-white"> <tr> <th style="width: 20%">Pays d’exportation</th></tr>' +
