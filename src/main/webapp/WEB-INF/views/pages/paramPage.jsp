     ...
     <div class="row mt-3" dir="${pageContext.response.locale=='ar'?'rtl':'ltr'}">
         <div class="col-xl-2 col-lg-3 col-md-3 col-sm-12">
             <div class="nav flex-column nav-pills bg-white" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                 <a onclick="getFunctionParam('getParamRegion/0/6')" class="nav-link active" id="v-pills-region-tab" data-toggle="pill" role="tab" aria-controls="v-pills-home" aria-selected="true"><spring:message code="label.Region"/></a>
                 ...
                 <a onclick="getFunctionParam('getParamCode/0/6')" class="nav-link" id="v-pills-code-tab" data-toggle="pill"  role="tab" aria-controls="v-pills-messages" aria-selected="false"><spring:message code="label.Code"/></a>
                 ...
                 <a onclick="getFunctionParam('getParamPrefecture/0/6')" class="nav-link" id="v-pills-prefecture-tab" data-toggle="pill" role="tab" aria-controls="v-pills-settings" aria-selected="false"><spring:message code="label.Prefecture"/></a>
                 <a onclick="getFunctionParam('getParamCommune/0/6')" class="nav-link" id="v-pills-commune-tab" data-toggle="pill" role="tab" aria-controls="v-pills-settings" aria-selected="false"><spring:message code="label.Commune"/></a>
                 ...
                 <a onclick="getFunctionParam('getParamDoc/0/6')" class="nav-link" id="v-pills-Doc_autorisation-tab" data-toggle="pill" role="tab" aria-controls="v-pills-settings" aria-selected="false"><spring:message code="label.Documentparautorisation"/></a>
                 ...
                 <a onclick="getFunctionParam('getParampays/0/6')" class="nav-link" id="v-pills-Pays-tab" data-toggle="pill"  role="tab" aria-controls="v-pills-settings" aria-selected="false"><spring:message code="label.Pays"/></a>
                 <a onclick="getFunctionParam('getParamTransporteur/0/6')" class="nav-link" id="v-pills-Transportateur-tab" data-toggle="pill" role="tab" aria-controls="v-pills-settings" aria-selected="false"><spring:message code="label.Transporteur"/></a>
                 <a onclick="getFunctionParam('getParamMoyenTransport/0/6')" class="nav-link" id="v-pills-Moyen_Transport-tab" data-toggle="pill" role="tab" aria-controls="v-pills-settings" aria-selected="false"><spring:message code="label.MoyendeTransport"/></a>
                 ...
                 <a onclick="getFunctionParam('getParamNatureActivite')" class="nav-link" id="v-pills-Nature_activité-tab" data-toggle="pill" role="tab" aria-controls="v-pills-settings" aria-selected="false"><spring:message code="label.NatureActivite"/></a>
                 <a onclick="getFunctionParam('getParamStatutProjet/0/6')" class="nav-link" id="v-pills-Statut-Projet-tab" data-toggle="pill" role="tab" aria-controls="v-pills-settings" aria-selected="false"><spring:message code="label.StatutduProjet"/></a>
                 <a onclick="getFunctionParam('getParamRenouvellement/0/6')" class="nav-link" id="v-pills-Renouvellement-tab" data-toggle="pill" role="tab" aria-controls="v-pills-settings" aria-selected="false"><spring:message code="label.renouvellement"/></a>
                 ...
                 <a onclick="getFunctionParam('getEmploye')" class="nav-link" id="v-pills-emp-tab" data-toggle="pill" role="tab" aria-controls="v-pills-settings" aria-selected="false">Employe</a>
                 <a onclick="getFunctionParam('getDepartement')" class="nav-link" id="v-pills-departement-tab" data-toggle="pill" role="tab" aria-controls="v-pills-settings" aria-selected="false">Departement</a>


                 <a onclick="getFunctionParam('getParamInstallation/0/6')" class="nav-link" id="v-pills-Installation-tab" data-toggle="pill" role="tab" aria-controls="v-pills-settings" aria-selected="false"><spring:message code="label.InstallationAutorise"/></a>
             </div>
         </div>
...
function getParamf(vals){
	...
	getFunctionParam('getParamRegion/'+vals+'/6');


}
function getParamP(vals){
    getFunctionParam('getParampays/'+vals+'/6');
}
function getParamPre(vals){
    getFunctionParam('getParamPrefecture/'+vals+'/6');
}
function getParamCommune(vals){
    getFunctionParam('getParamCommune/'+vals+'/6');
}
function getParamInstallation(vals){
    getFunctionParam('getParamInstallation/'+vals+'/6');
}
function getParamT(vals){
    getFunctionParam('getParamTransporteur/'+vals+'/6');
}
function getParamMoyen(vals){
    getFunctionParam('getParamMoyenTransport/'+vals+'/6');
}
$(document).ready(function (){
        $(".select2").select2();
    })
