...
<head>
    ...
    <link href="${pageContext.request.contextPath}/assets/css/style.bundle15aa.css?v=7.2.2" rel="stylesheet" type="text/css" />
    <style>
        .myButton:hover{
...
<div class="d-flex flex-column flex-root" style="margin-top:14rem">
    ...
    <div class="error error-5 d-flex flex-row-fluid bgi-size-cover bgi-position-center">
        ...
        <div class="container d-flex flex-row-fluid flex-column justify-content-md-center p-4 col-9 " >
            ...
            <h1 class="font-weight-boldest display-4 f-16  mt-2 mt-md-0 mb-12 m-auto " style="font-size: 25pt;color: #336c4e">Veuillez réessayer plus tard</h1>
