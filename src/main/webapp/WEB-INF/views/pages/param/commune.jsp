                                    ...
                                    <div class="progress">
                                          ...
                                          <div class="col-10 mt-4">
                                              ...
                                              <h3 class="ml6 float-right mb-1">
                                                      <span class="text-wrapper">
                                                        <span class="letters"><span class="letters"><spring:message code="label.Commune" /></span></span>
                                                      </span>
                                     ...
                                     <div class="col-12 mt-4">
                                       <div class="form-group">
                                         <label>Commune</label>
                                         <input type="text" id="nom_fr"  value="${Commune.nom_fr}"class="form-control">
                                       </div>
                                     </div>
                                     ...
                                     <div class="col-12">
                                       <div class="form-group" dir="rtl">
                                         <label>بلدية</label>
                                         <input type="hidden" id="id_Commune" value="${Commune.id_commune}" class="form-control">
                                       
                                         <input type="text" id="nom_ar" value="${Commune.nom_ar}" class="form-control">
                                       </div>
                                     </div>
                                            ...
                                            <div class="row  mb-4" style="margin:14px;">
                                              <a  class="btn btn-primary btn-block " onclick="addCommune()" ><spring:message code="label.Enregistrer"/> </a>
                                             <a class="btn btn-danger-2 text-white btn-block" onclick="getFunctionParam('getParamCommune/0/6')"><spring:message code="label.Annuler"/></a>
                                ...
                                <div class="col-3">
                                 ...
                                 <div class="col-9">
                                     <a class="button text-white fr_btn" onclick="frm_table('subtab_0','frm_etatDoss')">
                                         <span><spring:message code="label.NouvelleCommune"/> </span></a>
                                         ...
                                         <td class="text-center">
                                           <ul class="list-inline m-0">
                                             <li class="list-inline-item">
                                               <button onclick="updateCommune(${f.id_commune})" class="btn btn-outline-warning btn-sm rounded-circle tab_edit" type="button" title="Editer" style="background-color: white">
                                             ...
                                             <li class="list-inline-item">
                                               <button onclick="delete_Commune(${f.id_commune})" class="btn btn-outline-danger btn-sm rounded-circle tab_trash" type="button" title="Supprimer" style="background-color: white">
                                                 <div class="icon_trash_1">
                            ...
                            <c:choose>
                                <c:when test="${listF!='[]'}"> <div class="text-center" dir="ltr">
                                    ...
                                    <c:if test="${totalPage>0}">
                                        ...
                                        <select class="custom-select" id="optionselected" onchange="getParamCommune(this.value)" style="margin: auto; width: 100px" >
...
function addCommune(){
	...
	function updateCommune(id){
		$.ajax({
			 type : "GET",
			 url :"/api/updateCommune/"+id,
			 data:{
