    ...
    <div class="col-12 from_add" id="frm_etatDoss" style="display: none; margin-top: 43px; padding-right: 20%; float: none;">
        <div class="row p-0 m-0 justify-content-center">
            <div class="col-xl-5 col-lg-7 mt-5 col-sm-12 mt-5 grid-margin" >
                ...
                <form name="prefecture" id="prefecture">
                    <div class="card">
                            ...
                            <div class="col-10 mt-4">
                                ...
                                <h3 class="ml6 float-right mb-1">
                                                      <span class="text-wrapper">
                                                        <span class="letters"><span class="letters"><spring:message code="label.Prefecture" /></span></span>
                                                      </span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mt-4">
                                        <div class="form-group">
                                            ...
                                            <input required type="hidden" id="id_prefecture" value="${prefecture.id_prefecture}" class="form-control">
                                            <input required type="text" id="nom_fr" value="${prefecture.nom_fr}" class="form-control">
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12" dir="rtl">
                                        <div class="form-group" dir="rtl">
                                            <label dir="rtl">المحافظة</label>
                                            <input  required type="text" id="nom_ar" value="${prefecture.nom_ar}" class="form-control">
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12" dir="rtl">
                                        <div class="form-group">
                                            ...
                                            <select data-width="100%" multiple id="commune" class="form-control select2">
                                                <c:forEach items="${commune }" var="c">
                                                    <option <c:forEach items="${prefecture.commune }" var="pc"> <c:if test="${c.id_commune == pc.id_commune}">selected</c:if> </c:forEach> value="${c.id_commune}">${c.nom_fr }</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                        ...
                        <div class="row  mb-4" style="margin:14px;">
                            <a  class="btn btn-success btn-block " onclick="addPrefecture()" > <spring:message code="label.Enregistrer" /></a>
                            <a class="btn btn-danger-2 text-white btn-block" onclick="getFunctionParam('getParamPrefecture/0/6')"><spring:message code="label.Annuler" /></a>
                        ...
                        <div class="row m-0">
                            ...
                            <div class="col-9">
                                <a class="button text-white fr_btn" onclick="frm_table('subtab_0','frm_etatDoss')">
                                    <span><spring:message code="label.NouvellePrefecture" /></span>
                                </a>
                    ...
                    <div class="col-12" id="tr">
                        <table id="example2" class="table tablee table-hover">
                            ...
                            <tr>
                                ...
                                <th class="text-center"><spring:message code="label.Commune"/></th>
                            ...
                            <c:forEach items="${listF}" var="f">
                                ...
                                <tr id="tr-${f.id_prefecture}">

                                    <%-- <td>${f.nom_fr}</td> --%>
                                    <td>${f[lng]}</td>
                                    <td><c:forEach items="${f.commune}" var="c">
                                        ${c.nom_fr}
                                    </c:forEach> </td>
                                    ...
                                    <td class="text-center">
                                        <ul class="list-inline m-0">
                                            <li class="list-inline-item">
                                                <button onclick="editPrefecture(${f.id_prefecture})" class="btn btn-outline-warning btn-sm rounded-circle tab_edit" type="button" title="Editer" style="background-color: white">
                                            ...
                                            <li class="list-inline-item">
                                                <button onclick="deletePrefecture(${f.id_prefecture})" class="btn btn-outline-danger btn-sm rounded-circle tab_trash" type="button" title="Supprimer" style="background-color: white">
                                                    <div class="icon_trash_1">
                        ...
                        <c:choose>
                            <c:when test="${listF!='[]'}"> <div class="text-center" dir="ltr">
                                ...
                                <c:if test="${totalPage>0}">
                                    ...
                                    <select class="custom-select" id="optionselected" onchange="getParamPre(this.value)" style="margin: auto; width: 100px" >
...
<script type="text/javascript">
    ...
    function addPrefecture(){
        ...
        var id_prefecture=$("#id_prefecture").val();
    ...
    function editPrefecture(id){
        $.ajax({
            type : "GET",
            url :"/api/updatePrefecture/"+id,
            data:{
    ...
    function searchBy() {
        ...
        $.ajax({
            url: "/api/getPrefectureSearch/"+nom,
            type: "GET",
