                                          ...
                                          <div class="col-10 mt-4">
                                              ...
                                              <h3 class="ml6 float-right mb-1">
                                                      <span class="text-wrapper">
                                                        <span class="letters"><span class="letters"><spring:message code="label.ZonneFranche" /></span></span>
                                                      </span>
                                              ...
                                              <div class="col-12 mt-4">
                                                <div class="form-group">
                                                  <label>Zone franche</label>
                                                    <input required type="hidden" id="id_zonnefranche" value="${zonne.id_zonnefranche}" class="form-control">
                                                  <input  required type="text" id="nom_fr" value="${zonne.nom_fr}" class="form-control">
                                               </div>
                                              ...
                                              <div class="col-12" dir="rtl">
                                                <div class="form-group" dir="rtl">
                                                  <label dir="rtl"> المنطقة الحرة </label>
                                                  <input  required type="text" id="nom_ar" value="${zonne.nom_ar}" class="form-control">
                                               </div>
                                              ...
                                              <div class="col-12">
                                                <div class="form-group">
                                                  <label><spring:message code="label.CodeZonnefranche"/></label>
                                                  <input  required type="text" value="${zonne.code}"  id="code" class="form-control">
                                               </div>
                                            ...
                                            <div class="row  mb-4" style="margin:14px;">
                                              <a  class="btn btn-success btn-block " onclick="addZonne()" > <spring:message code="label.Enregistrer" /></a>
                                            <a class="btn btn-danger-2 text-white btn-block" onclick="getFunctionParam('getParamZonne')"><spring:message code="label.Annuler"/></a>
                                ...
                                <div class="col-3">
                                 ...
                                 <div class="col-9">
                                     <a class="button text-white fr_btn" onclick="frm_table('subtab_0','frm_etatDoss')">
                                         <span><spring:message code="label.NouvelleZonnefranche" /> </span></a>
                            ...
                            <table id="example2" class="table tablee table-hover">
                                <thead>
                                       <tr>
                                         ...
                                         <th class="text-center"><spring:message code="label.ZonneFranche" /></th>
                	                     <th class="text-center"><spring:message code="label.CodeZonnefranche" /> </th>
                                         ...
                                         <td class="text-center">
                                           <ul class="list-inline m-0">
                                             <li class="list-inline-item">
                                               <button onclick="editZonne(${f.id_zonnefranche})" class="btn btn-outline-warning btn-sm rounded-circle tab_edit" type="button" title="Editer" style="background-color: white">
                                             ...
                                             <li class="list-inline-item">
                                               <button onclick="deleteZone(${f.id_zonnefranche})" class="btn btn-outline-danger btn-sm rounded-circle tab_trash" type="button" title="Supprimer" style="background-color: white">
                                                 <div class="icon_trash_1">
...
function addZonne(){
    ...
    var id_zonnefranche=$("#id_zonnefranche").val();
    var code=$("#code").val();
	
	var fournisseur={

	        "id_zonnefranche":id_zonnefranche,
            "nom_fr":nom_fr,
			"nom_ar":nom_ar,
			"code":code
...
function editZonne(id){
    $.ajax({
        type : "GET",
        url :"/api/updateParamZonne/"+id,
        data:{
