                ...
                <div class="col-xl-5 col-lg-7 mt-5 col-sm-12 mt-5 grid-margin" >
                    ...
                    <div class="card">
                            ...
                            <div class="col-10 mt-4">
                                ...
                                <h3 class="ml6 float-right mb-1">
                                                      <span class="text-wrapper">
                                                        <span class="letters"><span class="letters"><spring:message code="label.NatureActivite" /></span></span>
                                                      </span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mt-4">
                                        <div class="form-group">
                                            <label><spring:message code="label.NatureActivite"/></label>
                                            <input  required type="text" id="nom_fr"  value="${natureActivite.nom_fr}" class="form-control">
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12" dir="rtl">
                                        <div class="form-group" dir="rtl">
                                            <label dir="rtl">النشاط</label>

                                            <input  required type="hidden" id="id_natureActivite" value="${natureActivite.id_natureActivite}"  class="form-control">

                                            <input  required type="text" id="nom_ar" value="${natureActivite.nom_ar}"  class="form-control">
                                        </div>
                        ...
                        <div class="row  mb-4" style="margin:14px;">
                            <a  class="btn btn-success btn-block " onclick="addNatureActivite()" ><spring:message code="label.Enregistrer" /> </a>
                            <a class="btn btn-danger-2 text-white btn-block" onclick="getFunctionParam('getParamNatureActivite')"><spring:message code="label.Annuler"/></a>
                            ...
                            <div class="row m-0">
                                ...
                                <div class="col-9">
                                    <a class="button text-white fr_btn" onclick="frm_table('subtab_0','frm_etatDoss')">
                                        <span><spring:message code="label.NouvelleNatureActivite"/> </span></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <table id="example2" class="table tablee table-hover">
                                ...
                                <tr>
                                          ...
                                          <th class="text-center"><spring:message code="label.NatureActivite"/></th>
                                        ...
                                        <td class="text-center" style="width: 15%">
                                            <ul class="list-inline m-0">
                                                <li class="list-inline-item">
                                                    <button onclick="editNatureActivite(${f.id_natureActivite})" class="btn btn-outline-warning btn-sm rounded-circle tab_edit" type="button" title="Editer" style="background-color: white">
                                                ...
                                                <li class="list-inline-item">
                                                    <button onclick="deleteNatureActivite(${f.id_natureActivite})" class="btn btn-outline-danger btn-sm rounded-circle tab_trash" type="button" title="Supprimer" style="background-color: white">
                                                        <div class="icon_trash_1">
...
<script type="text/javascript">
    function addNatureActivite(){

        var nom_fr=$("#nom_fr").val();
        var nom_ar=$("#nom_ar").val();
        var id_natureActivite=$("#id_natureActivite").val();

        var fournisseur={

            "nom_fr":nom_fr,
            "nom_ar":nom_ar,
            "id_natureActivite":id_natureActivite
        ...
        $.ajax({
            ...
            url :"/api/postParamNatureActivite",
    ...
    function deleteNatureActivite(id){
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type : "POST",
                        url :"/api/deleteParamNatureActivite/"+id,
                        data:{
                            "id":id
                        },
    ...
    function editNatureActivite(id){
        $.ajax({
            type : "GET",
            url :"/api/updateParamNatureActivite/"+id,
            data:{
