        ...
        <div class="col-12 from_add" id="frm_etatDoss" style="display: none; margin-top: 43px; padding-right: 20%; float: none;">
            <div class="row p-0 m-0 justify-content-center">
                <div class="col-xl-5 col-lg-7 mt-5 col-sm-12 mt-5 grid-margin" >
                    ...
                    <form name="statutProjet" id="statutProjet">
                        <div class="card" >
                                ...
                                <div class="col-10 mt-4">
                                    ...
                                    <h3 class="ml6 float-right mb-1">
                                                      <span class="text-wrapper">
                                                        <span class="letters"><span class="letters"><spring:message code="label.StatutduProjet" /></span></span>
                                                      </span>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <input  required type="text" id="nom_fr" value="${statut.nom_fr}" class="form-control">
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12" dir="rtl">
                                            <div class="form-group" dir="rtl">
                                                <label dir="rtl">حالة المشروع </label>
                                                <input  required type="hidden" id="id_statut_projet" value="${statut.id_statut_projet}" class="form-control">

                                                <input  required type="text" id="nom_ar" value="${statut.nom_ar}" class="form-control">
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input  required type="text" id="type" value="${statut.type}" class="form-control">
                                            </div>
                            ...
                            <div class="row  mb-4" style="margin:14px;">
                                <a  class="btn btn-success btn-block " onclick="addstatutProjet()" > <spring:message code="label.Enregistrer" /></a>
                                <a class="btn btn-danger-2 text-white btn-block" onclick="getFunctionParam('getParamStatutProjet/0/6')"><spring:message code="label.Annuler"/></a>
        ...
        <!-- fin etat Dossier -->
            <div class="col-12 grid-margin z_tab" id="subtab_0">
                <div>
                            ...
                            <div class="row p-4 justify-content-center">
                                <div class="col-8">
                                    <div class="row p-0">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label><spring:message code="label.StatutduProjet"/></label>
                            ...
                            <div class="row m-0">
                                ...
                                <div class="col-9">
                                    <a class="button text-white fr_btn" onclick="frm_table('subtab_0','frm_etatDoss')">
                                        <span><spring:message code="label.NouvelleStatut"/></span></a>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12">
                            <table style="margin-bottom:12px;" id="example2" class="table tablee table-hover">
                                <thead>
                                <tr>
                                        ...
                                        <td class="text-center">
                                            <ul class="list-inline m-0">
                                                <li class="list-inline-item">
                                                    <button onclick="editStatutProjet(${f.id_statut_projet})" class="btn btn-outline-warning btn-sm rounded-circle tab_edit" type="button" title="Editer" style="background-color: white">
                                                ...
                                                <li class="list-inline-item">
                                                    <button onclick="deleteStatutProjet(${f.id_statut_projet})" class="btn btn-outline-danger btn-sm rounded-circle tab_trash" type="button" title="Supprimer" style="background-color: white">
                                                        <div class="icon_trash_1">
                            ...
                            <c:choose>
                                ...
                                <select class="form-control" id="optionselected" onchange="getParamf(this.value)" style="margin: auto; width: 100px" > 
...
function getParamf(vals){
	...
	getFunctionParam('getParamStatutProjet/'+vals+'/6');
	 
	 
}
    function addstatutProjet(){

        var nom_fr=$("#nom_fr").val();
        var nom_ar=$("#nom_ar").val();
        var type=$("#type").val();
        var id=$("#id_statut_projet").val();
        ...
        $.ajax({
            ...
            url :"/api/postParamStatutProjet",
            contentType : 'application/json; charset=utf-8',

            data : JSON.stringify(statuts),

            success : function(response) {
            	getFunctionParam('getParamStatutProjet/0/6');
    ...
    function deleteStatutProjet(id){
        $.ajax({
            type : "POST",
            url :"/api/deleteParamStatutProjet/"+id,
    ...
    function editStatutProjet(id){
        $.ajax({
            type : "GET",
            url :"/api/updateParamStatutProjet/"+id,
            data:{
