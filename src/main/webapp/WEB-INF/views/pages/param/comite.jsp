                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <select  required id="permanent" class="form-select bg-light" style="height: 40px">
                                                    <option value="oui" ${comite.permanent=='oui'?'selected':''}>${pageContext.response.locale=='ar'? "نعم":"Oui"}</option>
                                                    <option value="non" ${comite.permanent=='non'?'selected':''}>${pageContext.response.locale=='ar'? "لا":"Non"}</option>
                                                </select>
                                            </div>
