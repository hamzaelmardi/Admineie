...
public class CollecteTransporteur implements Serializable {
  ...
  @Column(name = "n_pdf", nullable = true, columnDefinition = "int default 0")
  private int n_pdf;
  @Column(name = "numero_demande_pdf", nullable = true, columnDefinition = "NVARCHAR(255)")
  private String numero_demande_pdf;
  ...
  @ManyToOne(fetch = FetchType.EAGER)
  @JoinColumn(name = "compteAffecte")
  private Compte compteAffecte;

  public Compte getCompteAffecte() {
    return compteAffecte;
  }

  public void setCompteAffecte(Compte compteAffecte) {
  ...
  @ManyToMany(fetch = FetchType.LAZY)
  @Fetch(FetchMode.SELECT)
  @JoinTable(name = "codelistTmp2", joinColumns = {
          @JoinColumn(name = "id_collecte2") }, inverseJoinColumns = { @JoinColumn(name = "id_code_tmp2") })

  private List<Code> codeTmp2 = new ArrayList<>();

  public List<Code> getCodeTmp2() {
    return codeTmp2;
  }

  public void setCodeTmp2(List<Code> codeTmp2) {
    this.codeTmp2 = codeTmp2;
  }
...
public void setDateInfomration(Date dateInfomration) {
  ...
  @Column(name = "qarar", nullable = true, columnDefinition = "NVARCHAR(255)")
  private String qarar;

  @Column(name = "tatmim", nullable = true, columnDefinition = "NVARCHAR(255)")
  private String tatmim;
  ...
  public String getTatmim() {
    return tatmim;
  }

  public void setTatmim(String tatmim) {
    this.tatmim = tatmim;
  }
  ...
  public void setN_pdf(int n_pdf) {
    this.n_pdf = n_pdf;
  }

  public String getNumero_demande_pdf() {
    return numero_demande_pdf;
  }

  public void setNumero_demande_pdf(String numero_demande_pdf) {
    this.numero_demande_pdf = numero_demande_pdf;
  }
}
