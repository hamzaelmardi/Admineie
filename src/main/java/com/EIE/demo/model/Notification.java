...
public class Notification implements Serializable {
	...
	@Column(name = "dateAvisDepartement", nullable = true)
	private Date dateAvisDepartement;
	...
	public
	Date getDateAvisDepartement() {
		return dateAvisDepartement;
	}

	public
	void setDateAvisDepartement(Date dateAvisDepartement) {
		this.dateAvisDepartement = dateAvisDepartement;
	}
